function crack() {
    ...
    function wordSearch(word, def = 0) {
        document.getElementsByTagName('body')[0].innerHTML += '<div style="width:20%; font-size:15px; float:left;"><h2>' + word + '</h2></div>';
        ...
        xhr.onreadystatechange = function() {
            if (xhr.readyState === 4) {
                ...
                if (raw.includes('Latin_non-lemma_forms') && def == 0) {
                    ...
                    document.getElementsByTagName('div')[document.getElementsByTagName('div').length-1].innerHTML += res;
                } 
